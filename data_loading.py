...
"""
the following step splits the address into three parts: street address, city, state & 
zip code. We will assign them into corresponding columns by proper indexing.
"""
...
data["agency_street"] = address_parts[0].str.strip()  # Street address
data["agency_city"] = address_parts[1].str.strip()    # City
...
"""
FOR TESTING:
stmt_view = "SELECT * FROM agency_address;"
